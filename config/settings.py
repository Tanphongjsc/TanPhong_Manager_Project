...
MIDDLEWARE = [
    ...
    'config.middleware.session_expired.SessionExpiredMiddleware',
...
LANGUAGE_CODE = 'vi'
USE_THOUSAND_SEPARATOR = True  # Bật phân cách nghìn
NUMBER_GROUPING = 3
...
SESSION_COOKIE_AGE = 28800  # 8 giờ (1 ca làm việc)
...
LOGGING = {
    ...
    'loggers': {
        ...
        'apps.hrm_manager.lich_lam_viec.tasks': {
            'handlers': ['file', 'console'],
            'level': 'INFO',
            'propagate': False,
        },
