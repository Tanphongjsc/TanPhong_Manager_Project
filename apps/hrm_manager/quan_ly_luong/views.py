...
from django.db.models import F, Q, Sum, Count, FloatField
from django.db.models.functions import Coalesce

from apps.hrm_manager.__core__.models import Bangluong, Phantuluong, Nhomphantuluong, Thietlapsolieucodinh, Phieuluong, Quytacchedoluong, Bangchamcong, Lichsucongtac, Ctphieuluong, NhanvienChedoluong, Lichlamviecthucte
