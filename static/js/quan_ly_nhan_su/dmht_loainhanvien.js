    ...
    initTable() {
        this.tableManager = new TableManager({
            ...
            onRenderRow: (item) => {
                ...
                // Logic: Mặc định thì hiện Badge, còn lại hiện Toggle (màu xanh dương)
                const statusHtml = isDefault
                    ? `<span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">Mặc định</span>`
                ...
                tr.innerHTML = `
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="javascript:void(0);" onclick="window.LoaiNhanVienManager.openSidebar('edit', ${item.id})" class="text-sm font-medium text-blue-600 hover:text-blue-700">
                            ${item.TenLoaiNV}
                        </a>
                    </td>
